      ...
      <ScrollView style={ estilos.containerScroll }>
        ...
        <View style={ estilos.cardVinho }>
          ...
          <View style={ estilos.cardBoxDescricao}>
            ...
            <Text style={ estilos.cardDescricao}>Vinho estruturado, com sabor de cerveja vermelha madura, framboesa, notas de tabaco e taninos aveludados. Sua cor é vermelho granada e é perfeito com carnes vermelhas e molhos encorpados</Text>
          </View>
        </View>        
      </ScrollView>
    </View>
